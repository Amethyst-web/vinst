function Product(form, options) {
    ...
    this.form.find('select.sku-feature').change(function(){
        $('.feature').find('#feature_'+$(this).data('feature-id')).html($(this).find('option:selected').html());
    });
    ...
    this.form.find(".sku-feature").change(function () {
        ...
        if (sku) {
            ...
            //    self.button.attr('disabled', 'disabled');
            //}
            self.form.find(".price").data('price', sku.price);
...
Product.prototype.updatePrice = function (price, compare_price) {
    if (price === undefined) {
        ...
        //} else {
            price = parseFloat(this.form.find(".price").data('price'));
        //}
    }
    //if (compare_price) {
    ...
    //    }
    //});
    this.form.find(".price").html(this.currencyFormat(price));
};
